...
**Set status:** Sets 1-4 done (2026-08-12); Sets 5-6 pending. Set 1 completed the schema, Phase 1 split, and prerequisite additions. Sets 2-4 completed all 16 nodes in each of Phases 4, 5, and 6, including four plain-language explanation depths, six tiered MCQs per node, practice ladders where useful, acyclic dependency edges, and 18-question Bloom evaluation sets enforced by the runtime and validator maps. Set 3 retained the approved backpropagation checkpoint unchanged.
