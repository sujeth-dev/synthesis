...
- Two consecutive correct answers advance a practice stage; mixed evidence holds; two consecutive errors step down one stage, always keeping the same skill and using unseen questions when available.
