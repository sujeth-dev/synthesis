...
**Status:** blocked · **Depends on:** BLOOM-6, Phase 1 done
...
**Set status:** Sets 1-5 done (2026-08-12); Set 6 blocked on the documented 119-versus-120 total contradiction. Set 1 completed the schema, Phase 1 split, and prerequisite additions. Sets 2-4 completed all 16 nodes in each of Phases 4, 5, and 6; Set 5 completed all 14 Phase 7 nodes. Every completed phase includes four plain-language explanation depths, six tiered MCQs per node, practice ladders where useful, acyclic dependency edges, and an enforced 18-question Bloom evaluation. Set 3 retained the approved backpropagation checkpoint unchanged.
